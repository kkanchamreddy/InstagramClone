...
# Project 1 - *InstagramClone*

**InstagramClone** is an android app that allows a user to check out popular photos from Instagram. The app utilizes Instagram API to display images and basic image information to the user.
...
* [X] For each photo displayed, user can see the following details:
	* [X] Graphic, Caption, Username, like count
...
<img src='https://github.com/kkanchamreddy/InstagramClone/blob/master/demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
